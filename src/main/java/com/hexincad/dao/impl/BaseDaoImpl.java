...
import com.hexincad.Filter;
import com.hexincad.Filter.Operator;
import com.hexincad.Order;
import com.hexincad.Order.Direction;
import com.hexincad.Page;
import com.hexincad.Pageable;
import com.hexincad.dao.BaseDao;
import com.hexincad.entity.OrderEntity;
...
public abstract class BaseDaoImpl<T, ID extends Serializable> implements BaseDao<T, ID> {
	...
	public Page<T> findPage(Pageable pageable,T t) {
		...
		CriteriaQuery<T> criteriaQuery = criteriaBuilder.createQuery(entityClass);
		criteriaQuery.select(criteriaQuery.from(entityClass));
		pageable.setFilters(getFilters(t));
		return findPage(criteriaQuery, pageable);
	}
